export const en = {
  ...
  shipmentGrid: {
    ...
    printLimit: "Select up to {{max}} shipments to print.",
  },
  orderPage: {
  ...
  addShipment: {
    ...
    zoneDisabledPlaceholder: "Select a governorate first",
  ...
  scanDelivery: {
    ...
    noActions: "No actions available for this order.",
    actionRunning: "Applying…",
    actionSuccess: "Action applied.",
    actionError: "Couldn't apply action.",
    scanNext: "Scan next",
  },
  barcodeScanner: {
